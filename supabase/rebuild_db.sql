...
DROP TABLE IF EXISTS public.field_work_records CASCADE;
...
CREATE INDEX field_work_records_field_id_idx ON public.field_work_records (field_id);
CREATE INDEX field_work_records_latest_idx ON public.field_work_records (field_id, worked_on DESC NULLS LAST, created_at DESC, id DESC);
CREATE INDEX field_work_records_work_type_idx ON public.field_work_records (work_type_id);
...
CREATE POLICY "org_update_own" ON public.organizations FOR UPDATE USING (public.get_my_role() = 'admin' OR public.get_my_org_id() = id) WITH CHECK (public.get_my_role() = 'admin' OR public.get_my_org_id() = id);

-- profiles
CREATE POLICY "profiles_select_own_or_org" ON public.profiles FOR SELECT USING (auth.uid() = id OR public.get_my_role() = 'admin' OR public.get_my_org_id() = organization_id);
...
CREATE POLICY "fsp_select_own_org" ON public.field_source_polygons FOR SELECT USING (auth.role() = 'authenticated' AND (public.get_my_role() = 'admin' OR EXISTS (SELECT 1 FROM public.fields WHERE fields.id = field_source_polygons.field_id AND fields.organization_id = public.get_my_org_id())));
CREATE POLICY "fsp_insert_own_org" ON public.field_source_polygons FOR INSERT WITH CHECK (auth.role() = 'authenticated' AND (public.get_my_role() = 'admin' OR (public.get_my_role() = 'org_admin' AND EXISTS (SELECT 1 FROM public.fields WHERE fields.id = field_source_polygons.field_id AND fields.organization_id = public.get_my_org_id()))));
CREATE POLICY "fsp_delete_own_org" ON public.field_source_polygons FOR DELETE USING (auth.role() = 'authenticated' AND (public.get_my_role() = 'admin' OR (public.get_my_role() = 'org_admin' AND EXISTS (SELECT 1 FROM public.fields WHERE fields.id = field_source_polygons.field_id AND fields.organization_id = public.get_my_org_id()))));
...
CREATE POLICY "field_points_select_own_org" ON public.field_points FOR SELECT USING (auth.role() = 'authenticated' AND (public.get_my_role() = 'admin' OR EXISTS (SELECT 1 FROM public.fields WHERE fields.id = field_points.field_id AND fields.organization_id = public.get_my_org_id())));
CREATE POLICY "field_points_insert_own_org" ON public.field_points FOR INSERT WITH CHECK (auth.role() = 'authenticated' AND (public.get_my_role() = 'admin' OR (public.get_my_role() = 'org_admin' AND EXISTS (SELECT 1 FROM public.fields WHERE fields.id = field_points.field_id AND fields.organization_id = public.get_my_org_id()))));
CREATE POLICY "field_points_update_own_org" ON public.field_points FOR UPDATE USING (auth.role() = 'authenticated' AND (public.get_my_role() = 'admin' OR (public.get_my_role() = 'org_admin' AND EXISTS (SELECT 1 FROM public.fields WHERE fields.id = field_points.field_id AND fields.organization_id = public.get_my_org_id())))) WITH CHECK (auth.role() = 'authenticated' AND (public.get_my_role() = 'admin' OR (public.get_my_role() = 'org_admin' AND EXISTS (SELECT 1 FROM public.fields WHERE fields.id = field_points.field_id AND fields.organization_id = public.get_my_org_id()))));
CREATE POLICY "field_points_delete_own_org" ON public.field_points FOR DELETE USING (auth.role() = 'authenticated' AND (public.get_my_role() = 'admin' OR (public.get_my_role() = 'org_admin' AND EXISTS (SELECT 1 FROM public.fields WHERE fields.id = field_points.field_id AND fields.organization_id = public.get_my_org_id()))));
