...
CREATE OR REPLACE FUNCTION "public"."get_source_polygons_in_bbox"("west" double precision, "south" double precision, "east" double precision, "north" double precision) RETURNS TABLE("id" "text", "geom" "public"."geometry", "area_sqm" numeric, "original_properties" "jsonb")
...
ALTER FUNCTION "public"."get_source_polygons_in_bbox"("west" double precision, "south" double precision, "east" double precision, "north" double precision) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."field_points" (
    ...
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
    CONSTRAINT "field_points_point_type_check" CHECK (("point_type" = ANY (ARRAY['入口'::"text", '駐車場所'::"text", '水口'::"text", '落とし'::"text", '危険箇所'::"text", 'その他'::"text"])))
);


ALTER TABLE "public"."field_points" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."field_source_polygons" (
    "field_id" "uuid" NOT NULL,
    "source_polygon_id" "text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL
);


ALTER TABLE "public"."field_source_polygons" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    "display_name" "text",
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
    CONSTRAINT "profiles_role_check" CHECK (("role" = ANY (ARRAY['admin'::"text", 'org_admin'::"text", 'viewer'::"text"])))
);
...
ALTER TABLE "public"."source_polygons" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."field_points"
    ADD CONSTRAINT "field_points_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."field_source_polygons"
    ADD CONSTRAINT "field_source_polygons_pkey" PRIMARY KEY ("field_id", "source_polygon_id");
...
ALTER TABLE ONLY "public"."source_polygons"
    ADD CONSTRAINT "source_polygons_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."change_logs"
    ADD CONSTRAINT "change_logs_field_id_fkey" FOREIGN KEY ("field_id") REFERENCES "public"."fields"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."change_logs"
    ADD CONSTRAINT "change_logs_profile_id_fkey" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."field_points"
    ADD CONSTRAINT "field_points_field_id_fkey" FOREIGN KEY ("field_id") REFERENCES "public"."fields"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."field_source_polygons"
    ADD CONSTRAINT "field_source_polygons_field_id_fkey" FOREIGN KEY ("field_id") REFERENCES "public"."fields"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."field_source_polygons"
    ADD CONSTRAINT "field_source_polygons_source_polygon_id_fkey" FOREIGN KEY ("source_polygon_id") REFERENCES "public"."source_polygons"("id") ON DELETE CASCADE;
...
CREATE POLICY "change_logs_insert_own" ON "public"."change_logs" FOR INSERT WITH CHECK ((("auth"."role"() = 'authenticated'::"text") AND ("auth"."uid"() = "profile_id")));



CREATE POLICY "change_logs_select_own_org" ON "public"."change_logs" FOR SELECT USING ((("auth"."role"() = 'authenticated'::"text") AND (("public"."get_my_role"() = 'admin'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "change_logs"."profile_id") AND ("profiles"."organization_id" = "public"."get_my_org_id"())))))));
...
CREATE POLICY "field_points_delete_own_org" ON "public"."field_points" FOR DELETE USING ((("auth"."role"() = 'authenticated'::"text") AND (EXISTS ( SELECT 1
   FROM "public"."fields"
  WHERE (("fields"."id" = "field_points"."field_id") AND ("fields"."organization_id" = "public"."get_my_org_id"()))))));



CREATE POLICY "field_points_insert_own_org" ON "public"."field_points" FOR INSERT WITH CHECK ((("auth"."role"() = 'authenticated'::"text") AND (EXISTS ( SELECT 1
   FROM "public"."fields"
  WHERE (("fields"."id" = "field_points"."field_id") AND ("fields"."organization_id" = "public"."get_my_org_id"()))))));



CREATE POLICY "field_points_select_all" ON "public"."field_points" FOR SELECT USING (true);



CREATE POLICY "field_points_update_own_org" ON "public"."field_points" FOR UPDATE USING ((("auth"."role"() = 'authenticated'::"text") AND (EXISTS ( SELECT 1
   FROM "public"."fields"
  WHERE (("fields"."id" = "field_points"."field_id") AND ("fields"."organization_id" = "public"."get_my_org_id"())))))) WITH CHECK ((("auth"."role"() = 'authenticated'::"text") AND (EXISTS ( SELECT 1
   FROM "public"."fields"
  WHERE (("fields"."id" = "field_points"."field_id") AND ("fields"."organization_id" = "public"."get_my_org_id"()))))));
...
CREATE POLICY "fields_delete_own_org" ON "public"."fields" FOR DELETE USING ((("auth"."role"() = 'authenticated'::"text") AND ("public"."get_my_org_id"() = "organization_id")));



CREATE POLICY "fields_insert_own_org" ON "public"."fields" FOR INSERT WITH CHECK ((("auth"."role"() = 'authenticated'::"text") AND ("public"."get_my_org_id"() = "organization_id")));



CREATE POLICY "fields_select_all" ON "public"."fields" FOR SELECT USING (true);



CREATE POLICY "fields_update_own_org" ON "public"."fields" FOR UPDATE USING ((("auth"."role"() = 'authenticated'::"text") AND ("public"."get_my_org_id"() = "organization_id"))) WITH CHECK ((("auth"."role"() = 'authenticated'::"text") AND ("public"."get_my_org_id"() = "organization_id")));



CREATE POLICY "fsp_delete_own_org" ON "public"."field_source_polygons" FOR DELETE USING ((("auth"."role"() = 'authenticated'::"text") AND (EXISTS ( SELECT 1
   FROM "public"."fields"
  WHERE (("fields"."id" = "field_source_polygons"."field_id") AND ("fields"."organization_id" = "public"."get_my_org_id"()))))));



CREATE POLICY "fsp_insert_own_org" ON "public"."field_source_polygons" FOR INSERT WITH CHECK ((("auth"."role"() = 'authenticated'::"text") AND (EXISTS ( SELECT 1
   FROM "public"."fields"
  WHERE (("fields"."id" = "field_source_polygons"."field_id") AND ("fields"."organization_id" = "public"."get_my_org_id"()))))));



CREATE POLICY "fsp_select_all" ON "public"."field_source_polygons" FOR SELECT USING (true);



CREATE POLICY "org_delete_admin" ON "public"."organizations" FOR DELETE USING (("public"."get_my_role"() = 'admin'::"text"));



CREATE POLICY "org_insert_authenticated" ON "public"."organizations" FOR INSERT WITH CHECK (("auth"."role"() = 'authenticated'::"text"));
...
CREATE POLICY "org_update_own" ON "public"."organizations" FOR UPDATE USING (("public"."get_my_org_id"() = "id")) WITH CHECK (("public"."get_my_org_id"() = "id"));
...
CREATE POLICY "profiles_select_own_or_org" ON "public"."profiles" FOR SELECT USING ((("auth"."uid"() = "id") OR ("public"."get_my_org_id"() = "organization_id")));
...
CREATE POLICY "source_polygons_delete_admin" ON "public"."source_polygons" FOR DELETE USING (("public"."get_my_role"() = 'admin'::"text"));



CREATE POLICY "source_polygons_insert_authenticated" ON "public"."source_polygons" FOR INSERT WITH CHECK (("auth"."role"() = 'authenticated'::"text"));



CREATE POLICY "source_polygons_select_all" ON "public"."source_polygons" FOR SELECT USING (true);



CREATE POLICY "source_polygons_update_authenticated" ON "public"."source_polygons" FOR UPDATE USING (("auth"."role"() = 'authenticated'::"text")) WITH CHECK (("auth"."role"() = 'authenticated'::"text"));
...
GRANT ALL ON FUNCTION "public"."get_source_polygons_in_bbox"("west" double precision, "south" double precision, "east" double precision, "north" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."get_source_polygons_in_bbox"("west" double precision, "south" double precision, "east" double precision, "north" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_source_polygons_in_bbox"("west" double precision, "south" double precision, "east" double precision, "north" double precision) TO "service_role";
...
GRANT ALL ON TABLE "public"."field_points" TO "anon";
GRANT ALL ON TABLE "public"."field_points" TO "authenticated";
GRANT ALL ON TABLE "public"."field_points" TO "service_role";



GRANT ALL ON TABLE "public"."field_source_polygons" TO "anon";
GRANT ALL ON TABLE "public"."field_source_polygons" TO "authenticated";
GRANT ALL ON TABLE "public"."field_source_polygons" TO "service_role";
...
GRANT ALL ON TABLE "public"."source_polygons" TO "anon";
GRANT ALL ON TABLE "public"."source_polygons" TO "authenticated";
GRANT ALL ON TABLE "public"."source_polygons" TO "service_role";
